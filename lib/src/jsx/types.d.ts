...
export type PropsWithRef<T, P extends Props> = P & {
  ref?: RefObject<T>;
};

export type PropsWithChildren<P extends Props> = P & {
...
interface SVGFactory {
  (
    props?:
      | (PropsWithRef<SVGElement, Props> & SVGAttributes<SVGElement>)
      | null,
...
export type SVGElementTagNames = keyof SVGTags;
...
export type EventHandler<E extends Event, T = Element> = (
  this: T,
...
export type FormEventHandler<T = Element> = EventHandler<Event, T>;
export type ChangeEventHandler<T = Element> = EventHandler<Event, T>;
...
export type DetailedHTMLProps<E extends HTMLAttributes<T>, T> = PropsWithRef<
  T,
  Props
> &
  E;

export interface SVGProps<T> extends SVGAttributes<T>, PropsWithRef<T, Props> {}

type SVGTextElementAttributes<T> = SVGProps<T>;
type SVGLineElementAttributes<T> = SVGProps<T>;

type EventHandlers<T> = Record<string, EventHandler<Event, T> | undefined> & {
  // Clipboard Events
  ...
  // Image Events
  load?: EventHandler<Event, T> | undefined;
  error?: EventHandler<Event, T> | undefined; // also a Media Event
  // Keyboard Events
  keydown?: KeyboardEventHandler<T> | undefined;
  keypress?: KeyboardEventHandler<T> | undefined;
  keyup?: KeyboardEventHandler<T> | undefined;
  // Media Events
  abort?: EventHandler<Event, T> | undefined;
  canplay?: EventHandler<Event, T> | undefined;
  canplaythrough?: EventHandler<Event, T> | undefined;
  durationchange?: EventHandler<Event, T> | undefined;
  emptied?: EventHandler<Event, T> | undefined;
  encrypted?: EventHandler<Event, T> | undefined;
  ended?: EventHandler<Event, T> | undefined;
  loadeddata?: EventHandler<Event, T> | undefined;
  loadedmetadata?: EventHandler<Event, T> | undefined;
  loadstart?: EventHandler<Event, T> | undefined;
  pause?: EventHandler<Event, T> | undefined;
  play?: EventHandler<Event, T> | undefined;
  playing?: EventHandler<Event, T> | undefined;
  progress?: EventHandler<Event, T> | undefined;
  ratechange?: EventHandler<Event, T> | undefined;
  seeked?: EventHandler<Event, T> | undefined;
  seeking?: EventHandler<Event, T> | undefined;
  stalled?: EventHandler<Event, T> | undefined;
  suspend?: EventHandler<Event, T> | undefined;
  timeupdate?: EventHandler<Event, T> | undefined;
  volumechange?: EventHandler<Event, T> | undefined;
  waiting?: EventHandler<Event, T> | undefined;
  // MouseEvents
  ...
  // Selection Events
  select?: EventHandler<Event, T> | undefined;
  // Touch Events
...
export interface DOMAttributes<T> {
  ...
  onResize?: EventHandler<Event, T> | undefined;
  onResizeCapture?: EventHandler<Event, T> | undefined;
...
export interface HTMLAttributes<T> extends AriaAttributes, DOMAttributes<T> {
  ...
  class?: JSX.ClassNames | undefined;
...
declare global {
  namespace JSX {
    ...
    type Children = Child | Child[] | NodeList | HTMLCollection;

    interface Props {
      [x: string]: unknown;
    }

    type FunctionComponent = (props: Props | null) => Element;
